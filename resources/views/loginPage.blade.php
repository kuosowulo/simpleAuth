	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="login100-form-title" style="background-image: url('loginPage/images/loginPageBg.jpg')">
				...
				<form class="login100-form validate-form" method="POST" action="/simpleAuth/public/login">
					{{ csrf_field() }}
					...
					<div class="container-login100-form-btn">
						...
						<button class="login100-form-btn" onclick="location.href='thirdPartyAuth?type=Facebook'">
							FB登入
						</button>
					</div>
				</form>
